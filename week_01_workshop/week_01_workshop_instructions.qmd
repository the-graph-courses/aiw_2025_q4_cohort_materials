...
-   If you have a paid ChatGPT account, go to [chatgpt.com](https://chatgpt.com) and select the "Thinking" model. Otherwise, we recommend using Gemini at [gemini.google.com](https://gemini.google.com) and changing the model picker at top left to "Pro" if you still have some pro usage available. 
