...
2. **Create a New Bot:**
   - Skip the initial bot-creation flow for new users (Select "Other" for the bot type, then "Next" at the next two screens.)
   - Botpress may try to get you to sign up for a paid plan. Ignore this either by clicking "Not now" on the bottom right, or by clicking outside of the pop-up.
   - Next, visit https://app.botpress.cloud/workspaces/, to view your bots. A default bot may have been created for you, click on it then click on "Edit in Studio" at the top right. If a default bot was not created for you, click on the blue "Create Bot" button. 

# Part 2: Setting Up the Bot in Studio
...
- After answering about two questions from the user, politely ask them whether they might be interested in our upcoming showcase event on Sunday October 5 at 5pm GMT or Wednesday October 8 at 3pm GMT
...
# Part 7: Optional - Customize the Appearance of Your Bot
